...
ServerEvents.tags("block", (event) => {
  Color.DYE.forEach((color) => {
    ...
    if (!isVanillaDye(color)) {
      ...
      event.add(
        ...
        `bits_n_bobs:${color}_nixie_board`,
      );
      event.add(
        "minecraft:mineable/pickaxe",
        `bits_n_bobs:${color}_large_nixie_tube`,
      );
    }
  });
  ...
  const squash = ["blue", "green", "purple"];

  squash.forEach((block) => {
    event.add("deep_aether:squash", `deep_aether:${block}_squash`);
    event.add(
      "deep_aether:carved_squash",
      `deep_aether:carved_${block}_squash`,
    );
  });
...
ServerEvents.recipes((event) => {
  ...
  Color.DYE.forEach((color) => {
    if (!isVanillaDye(color)) {
      event.shapeless(`bits_n_bobs:${color}_chair`, [
        `dye_depot:${color}_wool`,
        Ingredient.of("#minecraft:wooden_stairs"),
      ]);
      event.shapeless(`bits_n_bobs:${color}_chair`, [
        `dye_depot:${color}_dye`,
        Ingredient.of("#bits_n_bobs:chairs"),
      ]);

      event.recipes.create.mixing(
        [
          `createdieselgenerators:${color}_cement`,
          CreateItem.of(`dye_depot:${color}_concrete_powder`, 0.25),
        ],
        [
          Fluid.of("minecraft:water", 100),
          `dye_depot:${color}_concrete_powder`,
        ],
      );

      event.shaped(`numismatics:${color}_card`, ["PID"], {
        P: "create:precision_mechanism",
        I: "create:iron_sheet",
        D: `dye_depot:${color}_dye`,
      });
      event.shaped(`numismatics:${color}_id_card`, [" D ", "IPB"], {
        D: `dye_depot:${color}_dye`,
        I: "create:iron_sheet",
        P: "minecraft:paper",
  ...
  event.replaceOutput(
    { output: "createbigcannons:steel_scrap" },
  ...
  event.replaceOutput(
    ...
    "create_ironworks:bronze_nugget",
  );

  event.shapeless("create_ironworks:steel_ingot", [
    "createbigcannons:steel_ingot",
  ]);
  event.shapeless("create_ironworks:steel_block", [
    "createbigcannons:steel_block",
  ]);
  event.shapeless("create_ironworks:steel_nugget", [
    "createbigcannons:steel_scrap",
  ]);
  event.shapeless("create_ironworks:bronze_ingot", [
    "createbigcannons:bronze_ingot",
  ]);
  event.shapeless("create_ironworks:bronze_block", [
    "createbigcannons:bronze_block",
  ]);
  event.shapeless("create_ironworks:bronze_nugget", [
    "createbigcannons:bronze_scrap",
  ]);
  ...
  event.shaped("betterend:end_stone_wall", ["SSS", "SSS"], {
    S: "minecraft:end_stone",
  });
  event.stonecutting("betterend:end_stone_wall", "minecraft:end_stone");

  event.recipes.create.deploying("create:turntable", [
  ...
  event.custom({
    ...
    results: [{ id: "simulated:spring", count: 1 }],
  });

  const casings = [
    { material: "create:shadow_steel", casing: "create:shadow_steel_casing" },
    {
      material: "create:refined_radiance",
      casing: "create:refined_radiance_casing",
    },
  ];

  casings.forEach((casing) => {
    event.recipes.create.deploying(casing.casing, [
  ...
  event.recipes.create
    .sequenced_assembly(
      ...
      [
        event.recipes.create.deploying("kubejs:unfinished_television_housing", [
          "kubejs:unfinished_television_housing",
          "create:iron_sheet",
        ]),
    ...
    .transitionalItem("kubejs:unfinished_television_housing")
    .loops(5);
  ...
  event.recipes.create
    .sequenced_assembly(
      ...
      [
        event.recipes.create.deploying("kubejs:incomplete_television", [
          "kubejs:incomplete_television",
  ...
  event.recipes.create.cutting(
    ["3x kubejs:tinted_glass_sheet"],
    "minecraft:tinted_glass",
  );
  event.recipes.create.deploying("vista:television", [
    "kubejs:open_television",
    "kubejs:tinted_glass_sheet",
  ]);
  ...
  event.recipes.create
    .sequenced_assembly(
      ...
      "create:andesite_casing",
      [
        event.recipes.create.deploying("kubejs:incomplete_viewfinder", [
          "kubejs:incomplete_viewfinder",
          "create:copper_sheet",
        ]),
        event.recipes.create.deploying("kubejs:incomplete_viewfinder", [
          "kubejs:incomplete_viewfinder",
  ...
  event.recipes.create
    .sequenced_assembly(
      ...
      [
        event.recipes.create.cutting(
          "kubejs:incomplete_rose_lens",
          "kubejs:incomplete_rose_lens",
        ),
        event.recipes.create.deploying("kubejs:incomplete_rose_lens", [
          "kubejs:incomplete_rose_lens",
          Ingredient.of("#create:sandpaper"),
        ]),
        event.recipes.create.filling("kubejs:incomplete_rose_lens", [
          Fluid.of("minecraft:water", 100),
          "kubejs:incomplete_rose_lens",
        ]),
      ],
    )
    .transitionalItem("kubejs:incomplete_rose_lens")
    .loops(3);
  ...
  event.recipes.create
    .sequenced_assembly(
      ...
      [
        event.recipes.create.deploying("kubejs:incomplete_optical_mechanism", [
          "kubejs:incomplete_optical_mechanism",
          "create:cogwheel",
        ]),
        event.recipes.create.deploying("kubejs:incomplete_optical_mechanism", [
          "kubejs:incomplete_optical_mechanism",
    ...
    .transitionalItem("kubejs:incomplete_optical_mechanism")
    .loops(3);

  event.shaped("vista:viewfinder", ["t ", "HM", "T "], {
  ...
  event.recipes.create.mixing(Fluid.of("kubejs:magnetic_slurry", 1000), [
    Ingredient.of("#c:dusts/iron", 2),
    Fluid.of("minecraft:water", 1000),
  ]);

  event.shaped("kubejs:cassette_shell", [" I ", "ISI", " I "], {
    S: "create:shaft",
    I: "create:iron_sheet",
  });
  ...
  event.recipes.create
    .sequenced_assembly(
      ...
      "minecraft:paper",
      [
        event.recipes.create.deploying("kubejs:unfinished_magnetic_tape", [
          "kubejs:unfinished_magnetic_tape",
    ...
    .transitionalItem("kubejs:unfinished_magnetic_tape")
    .loops(2);
  ...
  event.recipes.create
    .sequenced_assembly(
      ...
      "minecraft:paper",
      [
        event.recipes.create.filling("kubejs:unfinished_magnetic_tape", [
          Fluid.of("kubejs:magnetic_slurry", 100),
          "kubejs:unfinished_magnetic_tape",
        ]),
        event.recipes.create.deploying("kubejs:unfinished_magnetic_tape", [
          "kubejs:unfinished_magnetic_tape",
  ...
  event.shaped("vista:hollow_cassette", ["CTt"], {
    C: "kubejs:cassette_shell",
    T: "kubejs:magnetic_tape",
    t: "create:transmitter",
  });
  event.shaped("vista:hollow_cassette", ["Ct"], {
    C: "vista:cassette",
    t: "create:transmitter",
  });
  ...
  event.recipes.create.milling(
    [
      "kubejs:cornmeal",
      CreateItem.of("2x kubejs:cornmeal", 0.25),
      CreateItem.of("corn_delight:corn_seeds", 0.125),
    ],
    "corn_delight:corn_seeds",
  );
  event.recipes.farmersdelight.cooking(
    "meals",
    ["kubejs:cornmeal", "minecraft:milk_bucket"],
    "kubejs:polenta",
    0.35,
    100,
    "minecraft:bowl",
  ...
  event.shapeless("corn_delight:cornbread_batter", [
    Ingredient.of("#c:flours/corn"),
    "minecraft:milk_bucket",
    "minecraft:egg",
  ]);
  event.recipes.create.mixing("corn_delight:cornbread_batter", [
    Ingredient.of("#c:flours/corn"),
  ...
  const fill = (item, container, fluid, amount) => {
    event.recipes.create.filling(Item.of(item), [
  ...
  const pour = (item, container, fluid, amount) => {
    event.recipes.create.emptying(
      [Fluid.of(fluid, amount), container],
      Item.of(item),
    );
  };

  const bulkFermenting = (inputs, fluidInput, output, count, time, heat) => {
    const ingredients = fluidInput
      ? inputs.concat([
          { type: "fluid_stack", fluid: fluidInput, amount: 1000 },
        ])
      : inputs;
    const resultAmount = count
      ? { id: output, count: count }
      : { id: output, amount: 1000 };
    const baseRecipe = {
  ...
  fermenting(
    [{ tag: "c:crops/corn" }, { tag: "c:seeds/corn" }, [], []],
    "kubejs:bourbon",
  );
  bulkFermenting(
    [{ tag: "c:crops/corn" }, { tag: "c:seeds/corn" }],
  ...
  const cheeses = ["flaxen_cheese", "scarlet_cheese"];

  drinks.forEach((drink) => {
    fill(
      `brewinandchewin:${drink}`,
  ...
  cheeses.forEach((cheese) => {
    fill(
      `brewinandchewin:unripe_${cheese}_wheel`,
      "minecraft:honeycomb",
  ...
  bulkFermenting(
    [{ tag: "c:crops/rice" }, { item: "minecraft:brown_mushroom" }],
    "minecraft:water",
  ...
  bulkFermenting(
    ...
    "minecraft:milk",
    "brewinandchewin:scarlet_cheese",
    false,
    9600,
    "superheated",
  );
...
LootJS.modifiers((event) => {
  Color.DYE.forEach((color) => {
    if (!isVanillaDye(color)) {
      event
        .addBlockModifier(`bits_n_bobs:${color}_chair`)
        .addLoot(LootEntry.of(`bits_n_bobs:${color}_chair`));

      event
        .addBlockModifier(`bits_n_bobs:${color}_nixie_board`)
        .addLoot(LootEntry.of(`bits_n_bobs:nixie_board`));

      event
        .addBlockModifier(`bits_n_bobs:${color}_large_nixie_tube`)
