...
StartupEvents.registry('block', event => {
    ...
    .displayName('Andesite Casing Pillar')
    .hardness(1.5)
    .requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe')
    .tagBlock('minecraft:mineable/axe')
    .tagBlock('createbigcannons:splinter_effect_on_impact')
    .tagBlock('create:wrench_pickup')
    .tagBoth('kubejs:casing_pillars')

    event.create('brass_casing_pillar', 'pillar')
    .displayName('Brass Casing Pillar')
    .hardness(1.5)
    .requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe')
    .tagBlock('minecraft:mineable/axe')
    ...
    event.create('copper_casing_pillar', 'pillar')
    .displayName('Copper Casing Pillar')
    .hardness(1.5)
    .requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe')
    .tagBlock('minecraft:mineable/axe')
    ...
    event.create('railway_casing_pillar', 'pillar')
    .displayName('Railway Casing Pillar')
    .hardness(1.5)
    .requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe')
    .tagBlock('minecraft:mineable/axe')
    .tagBlock('createbigcannons:spark_effect_on_impact')
    .tagBlock('create:wrench_pickup')
    .tagBoth('kubejs:casing_pillars')

    event.create('shadow_steel_casing_pillar', 'pillar')
    .displayName('Shadow Steel Casing Pillar')
    .hardness(1.5)
    .requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe')
    .tagBlock('minecraft:mineable/axe')
    ...
    event.create('refined_radiance_casing_pillar', 'pillar')
    .displayName('Refined Radiance Casing Pillar')
    .hardness(1.5)
    .requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe')
    .tagBlock('minecraft:mineable/axe')
    ...
    event.create('creative_casing_pillar', 'pillar')
    .displayName('Creative Casing Pillar')
    .hardness(1.5)
    .requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe')
    .tagBlock('minecraft:mineable/axe')
