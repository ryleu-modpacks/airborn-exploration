...
StartupEvents.registry("item", (event) => {
  for (const group of groups) {
    if (group.type === "blank") {
      event
        .create("frequency_blank")
        .displayName("Blank Frequency")
        .texture("layer0", "kubejs:item/frequency/base")
        .tag("minecraft:dyeable")
        .tag("kubejs:frequency")
    ...
    for (const value of group.values) {
      event
        ...
        .tag("minecraft:dyeable")
        .tag("kubejs:frequency")
        .tag(`kubejs:frequency/${group.type}`)
        .color((stack, tintIndex) => {
          const dyed = stack.get($DataComponents.DYED_COLOR);
          if (tintIndex != 0) {
            if (dyed) {
  ...
  event
    .create("wet_magnetic_tape")
    .displayName("Wet Magnetic Tape")
    .texture("vista:item/picture_tape")
    .color("#699EE4");
  event
    .create("magnetic_tape")
    .displayName("Magnetic Tape")
    .texture("vista:item/picture_tape");
  event
    .create("cassette_shell")
    .displayName("Cassette Shell")
    .texture("vista:item/cassette");
  ...
  event
    .create("incomplete_rose_lens", "create:sequenced_assembly")
    .displayName("Incomplete Rose Lens")
    .texture("kubejs:item/rose_lens");
  event
    .create("unfinished_magnetic_tape", "create:sequenced_assembly")
    .displayName("Unfinished Magnetic Tape")
    .texture("vista:item/picture_tape");
  event
    .create("incomplete_optical_mechanism", "create:sequenced_assembly")
    .displayName("Incomplete Optical Mechanism")
    .texture("kubejs:item/optical_mechanism");
  event
    .create("unfinished_television_housing", "create:sequenced_assembly")
    .displayName("Unfinished Television Housing")
    .parentModel("kubejs:block/television_housing");
  event
    .create("incomplete_television", "create:sequenced_assembly")
    .displayName("Incomplete Television")
    .parentModel("kubejs:block/open_television");
  event
    .create("incomplete_viewfinder", "create:sequenced_assembly")
    .displayName("Incomplete Viewfinder")
    .texture("kubejs:item/viewfinder_housing");
  ...
  event
    .create("garlic_tomato_polenta")
    .displayName("Garlic Tomato Polenta")
    .tag("kubejs:polenta")
...
StartupEvents.registry("block", (event) => {
  event
    .create("television_housing", "cardinal")
  ...
  event
    .create("open_television", "cardinal")
...
StartupEvents.registry("fluid", (event) => {
  event.create("magnetic_slurry").displayName("Magnetic Slurry").noBlock();
